...
public class GoogleVoiceSpeech : MonoBehaviour {
    ...
    void OnTriggerExit(Collider other)
    {
        ...
        //{
            ...
            string apiURL = "https://speech.googleapis.com/v1/speech:recognize?&key=AIzaSyA6zfIh7hzMNpmaUcSk0pO8YOI9R4j7XGU";
            string Response;
    ...
    public string HttpUploadFile(string url, string file, string paramName, string contentType) {
        ...
        try
        {
            ...
            using (var streamWriter = new StreamWriter(httpWebRequest.GetRequestStream()))
            {
                ...
                string json = "{ \"config\": { \"languageCode\" : \"zh\" }, \"audio\" : { \"content\" : \"" + file64 + "\"}}";
